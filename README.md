...
**getWiFiIpAddress**: Retrieves IPv4 address of a device assigned with on a WiFi network for communication.
```javascript
...
**getCellularIpAddress**: Provides a cellular IPv4 address assigned by a mobile carrier. It's not a public IP address.
```javascript
